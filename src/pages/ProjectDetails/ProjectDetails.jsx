      ...
      <section className={darkMode ? "projects dark" : "projects"}>
        <div>
          ...
          <article className="projects__content">
            ...
            <div className="projects__content__description">
              <p>{skills[id].description}</p>
            </div>
            <div
              className={darkMode ? "projects__content__links dark" : "projects__content__links"}>
              <a href={skills[id].site} target="_blank">
              ...
              <a href={skills[id].repo} target="_blank">
                <svg fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
